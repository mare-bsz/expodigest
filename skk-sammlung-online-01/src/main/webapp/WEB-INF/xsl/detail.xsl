...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="record">
		<div class="record">
			...
			<h3 class="objektbezeichnung"><xsl:value-of select="./objektbezeichnung" /></h3>
			<div class="footer">
				<xsl:if test="./kurzbeschreibung">
					<p><xsl:text>In Kürze: </xsl:text><span class="kurzbeschreibung"><xsl:value-of select="./katalogtext"/></span></p>
				</xsl:if>
